        ...
        <SafeAreaView style={styles.MainContainer}>
            <ScrollView>
                ...
                <View style={{width:243,height:53,alignSelf:'center',marginBottom:30}}>
                    <Text style={{textAlign:'center',fontFamily:CommonStyle.Regular,fontSize:14,color:'#181461'}}>{t("Accédez à notre réseau de clients sans commission en souscrivant à notre")}</Text>
                    <Text style={{textAlign:'center',fontFamily:CommonStyle.Bold,fontSize:16,color:'#181461'}}>{t("abonnement mensuel de")} 100€</Text>
                </View>
                <View style={styles.whiteContainer}>
                    ...
                    <View style={styles.borderContainer}>
                        ...
                        <TextInput placeholderTextColor='E4EBF9' placeholder={t('Numéro de carte bancaire')} style={{width:'90%'}}/>
                    </View>
                    <View style={styles.borderContainer}>
                        <View style={{width:'10%',}}>
                        <Image source={Calender}/>
                        </View>
                        <TextInput placeholderTextColor='E4EBF9' placeholder={t("Date d'expiration")} style={{width:'90%'}}/>
                    </View>
                    <View style={styles.borderContainer}>
                        <View style={{width:'10%',}}>
                        <Image source={Crypto}/>
                    ...
                    <View style={{marginVertical:15}}>
                        <Button propsFun={CHECK} ButtonText={t('Payer et commencer')} ButtonStyle = 'red' />
                    </View>
                    <View>
